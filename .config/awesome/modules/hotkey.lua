...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioLowerVolume", function ()
        awful.util.spawn("pactl set-sink-volume @DEFAULT_SINK@ -0.5%", false)
    end),
    ...
    awful.key({}, "XF86AudioPlay", function()
        awful.util.spawn("mpc --host=192.168.1.119 toggle", false)
    end),
    awful.key({}, "XF86AudioStop", function()
        awful.util.spawn("mpc --host=192.168.1.119 stop", false)
    end),
    awful.key({}, "XF86AudioNext", function()
        awful.util.spawn("mpc --host=192.168.1.119 next", false)
    end),
...
for i = 1, 9 do
    ...
    {description = "increase window opacity(transparency)"}),
